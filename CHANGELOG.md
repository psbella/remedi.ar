...
El formato está basado en [Keep a Changelog](https://keepachangelog.com/en/1.0.0/) y el proyecto adhiere a [Semantic Versioning](https://semver.org/spec/v2.0.0.html).
