...
export function abrirModalInfo(hash, drogaMed) {
    ...
    panel.innerHTML = `
        ...
        <p class="modal-info-fuente">${info.inferido
            ...
            : 'Información de referencia, puede no reflejar cambios recientes.'}${atcMostrado ? ` Clasificación ATC: <a href="https://www.anmat.gob.ar/atc/CodigosATC.asp" target="_blank" rel="noopener noreferrer">ANMAT</a> · <a href="https://atcddd.fhi.no/atc_ddd_index/" target="_blank" rel="noopener noreferrer">OMS/WHOCC</a>.` : ''}</p>`;
