 ...
 * Ej: "acetilsalicílico,ác." → sin filtrar "ac.", el combo da null;
 * filtrado, "acetilsalicilico" solo matchea vía variantesAcido() con el
 * prefijo "acido " (verificado que "acido acetilsalicilico" existe en
 * atc_por_droga.json). Se comparan sin el punto final.
 *
 ...
 * específica cambie el código ATC real (no observado en los casos
...
/**
 * Sufijos de sal que aparecen PEGADOS con espacio al nombre de la droga
 * (no como token separado por coma) — ej: "diclofenac sódico" en vez de
 * "diclofenac,sodico". STOPWORDS_DROGA no los filtra porque son parte del
 * mismo token tras el split por coma. variantesAcido() prueba sacar el
 * sufijo y matchear la base sola.
 * Verificado (2026-09-02): "diclofenac" ya tiene entrada propia en
 * atc_por_droga.json, "diclofenac sodico"/"diclofenac potasico" no.
 * Mismo riesgo conocido que STOPWORDS_DROGA: se pierde la especificidad
 * de la sal en favor del código de la droga base.
 */
